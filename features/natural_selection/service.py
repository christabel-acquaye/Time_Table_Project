...
def over_crowding(non_dorminating_chromosomes, dorminating_chromosomes):
    ...
    for i in range((1,len(dorminating_chromosomes)-1)):
        crowding_distance[i] = crowding_distance[i]+ (fitness_value1[fitness_value1_sorted[i+1]] - fitness_value2[fitness_value1_sorted[i-1]])/(max(fitness_value1)-min(fitness_value1))
    for i in range((1,len(dorminating_chromosomes)-1)):
         crowding_distance[i] = crowding_distance[i]+ (fitness_value1[fitness_value2_sorted[i+1]] - fitness_value2[fitness_value2_sorted[i-1]])/(max(fitness_value2)-min(fitness_value2))
